const MEDIA = {
    ...
    packingEdit: require('./packing-aide/Edit.mp4'),
    packingUpdateContainer: require('./packing-aide/UpdateContainer.mp4'),
    packingSearch: require('./packing-aide/Search.mp4'),
    // goals
    goalStriveOpening: require('./goals/Opening.mp4'),
    goalStriveTips: require('./goals/Tips.mp4'),
